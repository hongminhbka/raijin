...
$sku = $product->get_sku() ? $product->get_sku() : esc_html__( 'n/a', 'vizeon' );
?>
<div class="product_meta">
	...
	<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
		...
		<span class="sku_wrapper"><?php esc_html__( '<span class="title">SKU:</span>', 'vizeon' ); ?> <span class="sku" itemprop="sku"><?php echo esc_html($sku); ?></span>.</span>
